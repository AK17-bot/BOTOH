...
#                            Name = summon(op.param2)
        ...
        if op.type == 17:
          if wait["Sambutan"] == True:
            ...
            vipro.sendText(op.param1,"Yoo" + vipro.getContact(op.param2).displayName + "\nSelamat datang di ☞ " + str(ginfo.name) + " ☜" + "\nBudayakan Cek Note\nDan Semoga Betah :v ")
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            if op.param2 in Creator:
                return
            vipro.sendText(op.param1,"Selamat Jalan Hati Hati " + vipro.getContact(op.param2).displayName +  "\nSee you next time ")
            d = Message(to=op.param1, from_=None, text=None, contentType=7)
            d.contentMetadata={
                                    "STKID": "13269542",
                                    "STKPKGID": "1329191",
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = vipro.getContact(msg.from_)
                     cName = contact.displayName
                     balas = [" Dasar Jones :v ",cName + " Ngapain Ngetag? ",cName + " Kenapa tag? Kangen? :v "," Dia Lagi Off :v ", cName + " Kenapa Tag Saya? "," Dia Lagi Tidur:v\nJangan Di Tag " + cName, 
" Suka ya sama gw :v " + cName, " Kamu Siapa " + cName + "?", " Ada Perlu Apa " + cName + "?"," Apa? " + cName + " Apasih tag tag hilih "]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention2"] == True:          
                    contact = vipro.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["Ada apa sih kangen ya? :v","Dasar jones :v","Oit " + cName + " Kenapa sih? :v"]
                    ret_ = random.choice(balas)
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention['MENTIONEES']
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention3"] == True:          
                    contact = vipro.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["Oit " + cName + ", memang jones nih :v "]
                    balas1 = "Ini foto si Jones yang suka ngetag"
                    ret_ = random.choice(balas)
                    image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
        ...
        if op.type == 25:
            ...
            if msg.text in ["Bot on"]:
                wait["Bot"] = True
                vipro.sendText(msg.to,"Bot udah on cuk.")  
        ...
        if op.type == 25:
          if wait["Bot"] == True:    
			...
			vipro.sendText(msg.to,"Admin Detected~")
                ...
                vipro.sendMessage(msg)
		vipro.sendText(msg.to,"Itu Majikan Kami :v")
            ...
            if msg.contentType == 13:
                if wait["gift"] == True:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                vipro.sendText(msg.to,"Gift terkirim")
                                msg.contentType = 9
		...
		gid = vipro.getGroupIdsJoined()
                if msg.from_ in Creator:
		    for i in gid:
			vipro.sendText(i,"Bot dipaksa keluar oleh owner")
		        vipro.leaveGroup(i)
		    ...
		    vipro.sendText(msg.to,"Khusus Admin")
                ...
                if msg.toType == 2:
                    ...
                    vipro.updateGroup(X)
                    vipro.sendText(msg.to,"Url telah aktif")
                else:
                    vipro.sendText(msg.to,"Can not be used outside the group")
                ...
                if msg.toType == 2:
                    ...
                    vipro.updateGroup(X)
                    vipro.sendText(msg.to,"Url telah dinonaktifkan")
		...
		if msg.from_ in admin:
                    ...
                    wait["AutoKick"] = True
                    wait["Qr"] = True
                    vipro.sendText(msg.to,"All Protect on")
		else:
		    vipro.sendText(msg.to,"Khusus Admin")
		...
		if msg.from_ in admin:
                    ...
                    wait["AutoKick"] = False
                    wait["Qr"] = False
                    vipro.sendText(msg.to,"All Protect off")
		else:
		    vipro.sendText(msg.to,"Khusus Admin")
                ...
                if wait["Sambutan"] == True:
                    if wait["lang"] == "JP":
                        vipro.sendText(msg.to,"Sambutan diaktifkan")
                else:
                    wait["Sambutan"] = True
                    if wait["lang"] == "JP":
                ...
                if wait["Sambutan"] == False:
                    if wait["lang"] == "JP":
                        vipro.sendText(msg.to,"Sambutan Dinonaktifkan")
                else:
                    wait["Sambutan"] = False
                    if wait["lang"] == "JP":
                ...
                wait["Sider"] = True
                vipro.sendText(msg.to,"Hayo yang sider siap siap")
                ...
                if msg.to in cctv['point']:
                    ...
                    vipro.sendText(msg.to, "Heh Belom diset")                         
		...
		if midd not in admin:
		    ...
		    vipro.sendText(msg.to,"Admin Detected")
                ...
                gs = vipro.getGroup(msg.to)
                vipro.sendText(msg.to,"Welcome cuk :v to "+ gs.name)
                msg.contentType = 7
		...
		vipro.sendText(msg.to,"Hadir cuk!")
		...
		vipro.sendText(msg.to, "Progress...")
              ...
              if msg.from_ in admin:
                ...
                if msg.from_ in admin:
                    wait["blacklist"] = {}
                    vipro.sendText(msg.to," ❉Unbanned All Success❉ ┐") 
